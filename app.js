...
var currentUser=require('./user.json')
...
//reading file for getting token 
// var tokenFromFile=  fs.readFileSync('./token.txt',{ encoding: 'utf8' })
...
// fs.writeFileSync("./User.json", JSON.stringify(token),  'utf8', function(err) {
...
fs.writeFile('./user.json', token, 'utf-8', function(err) {
if (err) throw err
console.log('Done!')
})
